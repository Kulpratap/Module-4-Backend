  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('custom_content_entity_example')->notice('New profile %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The profile %label has been updated.', $message_args));
        $this->logger('custom_content_entity_example')->notice('The profile %label has been updated.', $logger_args);
        break;
